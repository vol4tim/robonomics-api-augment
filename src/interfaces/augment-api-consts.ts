...
declare module '@polkadot/api-base/types/consts' {
  interface AugmentedConsts<ApiType extends ApiTypes> {
    ...
    datalog: {
       ...
       **/
      windowSize: u64 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
    ...
    lighthouse: {
       ...
       **/
      blockReward: u128 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
    ...
    rws: {
       ...
       **/
      auctionCost: u128 & AugmentedConst<ApiType>;
      /**
       * Subscription auction duration in blocks.
       **/
      auctionDuration: u32 & AugmentedConst<ApiType>;
      /**
       * Minimal auction bid.
       **/
      minimalBid: u128 & AugmentedConst<ApiType>;
      /**
       * Reference call weight, general transaction consumes this weight.
       **/
      referenceCallWeight: u64 & AugmentedConst<ApiType>;
      /**
       * Subscription weight accumulator limit.
       **/
      weightLimit: u64 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
