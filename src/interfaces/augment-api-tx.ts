...
import type { CumulusPrimitivesParachainInherentParachainInherentData, FrameSupportScheduleMaybeHashed, MainRuntimeOriginCaller, PalletAssetsDestroyWitness, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletMultisigTimepoint, PalletRobonomicsLiabilitySignedSignedAgreement, PalletRobonomicsLiabilitySignedSignedReport, PalletRobonomicsRwsSubscription, PalletVestingVestingInfo, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    crowdloan: {
       ...
       **/
      sendReward: AugmentedSubmittable<(recipient: AccountId32 | string | Uint8Array, rewardValue: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Compact<u128>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    datalog: {
       ...
       **/
      erase: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * Store new data into blockchain.
       **/
      record: AugmentedSubmittable<(record: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    digitalTwin: {
       ...
       **/
      setSource: AugmentedSubmittable<(id: u32 | AnyNumber | Uint8Array, topic: H256 | string | Uint8Array, source: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H256, AccountId32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    launch: {
       ...
       **/
      launch: AugmentedSubmittable<(robot: AccountId32 | string | Uint8Array, param: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, H256]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    liability: {
       ...
       **/
      create: AugmentedSubmittable<(agreement: PalletRobonomicsLiabilitySignedSignedAgreement | { technics?: any; economics?: any; promisee?: any; promisor?: any; promiseeSignature?: any; promisorSignature?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletRobonomicsLiabilitySignedSignedAgreement]>;
      /**
       * Publish technical report of complite works.
       **/
      finalize: AugmentedSubmittable<(report: PalletRobonomicsLiabilitySignedSignedReport | { index?: any; sender?: any; payload?: any; signature?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletRobonomicsLiabilitySignedSignedReport]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    lighthouse: {
       ...
       **/
      set: AugmentedSubmittable<(lighthouse: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    rws: {
       ...
       * # </weight>
       **/
      bid: AugmentedSubmittable<(index: u32 | AnyNumber | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Compact<u128>]>;
      /**
       ...
       * # </weight>
       **/
      call: AugmentedSubmittable<(subscriptionId: AccountId32 | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Call]>;
      /**
       ...
       * # </weight>
       **/
      setDevices: AugmentedSubmittable<(devices: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId32>]>;
      /**
       ...
       * # </weight>
       **/
      setOracle: AugmentedSubmittable<(updated: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress]>;
      /**
       * Change account bandwidth share rate by authority.
       * 
       ...
       * # </weight>
       **/
      setSubscription: AugmentedSubmittable<(target: AccountId32 | string | Uint8Array, subscription: PalletRobonomicsRwsSubscription | { Lifetime: any } | { Daily: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PalletRobonomicsRwsSubscription]>;
      /**
       ...
       * # </weight>
       **/
      startAuction: AugmentedSubmittable<(kind: PalletRobonomicsRwsSubscription | { Lifetime: any } | { Daily: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletRobonomicsRwsSubscription]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MainRuntimeOriginCaller | { Void: any } | { system: any } | { TechnicalCommittee: any } | { PolkadotXcm: any } | { CumulusXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MainRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
